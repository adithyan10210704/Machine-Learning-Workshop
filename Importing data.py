...
try:
    ...
    ''')
    cursor.execute('INSERT INTO DB3 (id, name, age) VALUES (1, "John Doe", 28)')
    cursor.execute('INSERT INTO DB3 (id, name, age) VALUES (2, "Jane Smith", 34)')
    cursor.execute('INSERT INTO DB3 (id, name, age) VALUES (3, "Emily Davis", 22)')
    conn.commit()

    # Import SQL data
    df_sql = pd.read_sql_query('SELECT * FROM DB3', conn)
    print("\nSQL Data:")
    print(df_sql)
except Exception as e:
